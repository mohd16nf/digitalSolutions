...
const ImageSlider = () => {
  ...
  const variants = {
    ...
    center: {
      opacity: 1,
      transition: { duration: 5 }, // Adjust slide change time here (in seconds)
    },
    exit: {
      opacity: 0,
    },
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden flex items-center justify-center">
      ...
      <div className="relative w-full h-full">
        <AnimatePresence initial={false} custom={direction}>
          <motion.div
            ...
            exit="exit"
            transition={{
              opacity: { duration: 5 }, // Adjust slide change time here (in seconds)
            }}
          ...
          >
            <div className="relative w-full h-full">
              ...
              <div className="w-1/2 flex pl-[300px] pt-[350px] flex-col text-white z-10">
                <motion.h1
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ delay: 0.2, duration: 5 }} // Adjust text appearing time here (in seconds)
                ...
                <motion.h2
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ delay: 0.5, duration: 4.5 }} // Adjust text appearing time here (in seconds)
                  className="text-2xl"
                >
      ...
      {/* Text section */}
      <div className="absolute bottom-0 w-full bg-black bg-opacity-60 text-white text-center py-4 overflow-hidden">
