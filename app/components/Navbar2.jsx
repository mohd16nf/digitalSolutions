    ...
    <div className="absolute top-0 left-0 w-full xl:py-4 pt-4 z-50 bg-[#17a2b8]">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden xl:block">
            <div className="ml-10 flex items-baseline space-x-6 ">
              <Link href="/" passHref>
                <span className="text-white text-xl cursor-pointer hover:text-orange-700">Home</span>
              </Link>
              ...
              <Link href="#client-section" passHref>
                <span className="text-white text-xl cursor-pointer hover:text-orange-700">Clients</span>
              </Link>
              <Link href="#about-section" passHref>
                <span className="text-white text-xl cursor-pointer hover:text-orange-700">About Us</span>
              </Link>
              <Link href="#contact-form" passHref>
                <span className="text-white text-xl cursor-pointer hover:text-orange-700">Get in Touch</span>
              </Link>
              <Link href="https://docs.google.com/presentation/d/1sns6Dz-WXB32vgDuFzob31SBbVO1D56y/edit?usp=sharing&ouid=107168939517355480908&rtpof=true&sd=true " target='_blank' passHref>
                <span className="text-white text-xl cursor-pointer hover:text-orange-700">Brochure</span>
              </Link>
            </div>
          </div>
      ...
      <div className={`${isMenuOpen ? 'block' : 'hidden'} xl:hidden bg-white`}>
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          <Link href="/" passHref>
            <span className="block text-black px-3 py-2 rounded-md font-medium cursor-pointer hover:text-orange-700">
              Home
            </span>
          </Link>
          <div className="relative group">
            <button className="block w-full text-left text-black px-3 py-2 rounded-md font-medium focus:outline-none">
              Product and Services
            </button>
          ...
          <Link href="https://docs.google.com/presentation/d/1sns6Dz-WXB32vgDuFzob31SBbVO1D56y/edit?usp=sharing&ouid=107168939517355480908&rtpof=true&sd=true " target='_blank' passHref>
            <span className="block text-black px-3 py-2 rounded-md text-base font-medium cursor-pointer hover:text-orange-700">
              Brochure
            </span>
          </Link>
